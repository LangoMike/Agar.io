...
class Food(pygame.sprite.Sprite):
    ...
    def __init__(self, world_surface=None, color: Optional[tuple] = None, 
                 center: Optional[tuple] = None, size: Optional[float] = None):
        super().__init__()
    ...
    def _generate_food_size(self) -> float:
        ...
        return 19.0  # Fallback to smallest size
    ...
    def draw(self, surface: pygame.Surface, camera_x: float, camera_y: float, 
        ...
        final_surface = pygame.transform.scale(self.image, (final_size * 2, final_size * 2))
